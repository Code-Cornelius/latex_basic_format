...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EXEMPLES
    SV/.style={
        ...
        before={\vspace{0.2cm}},
        after={\vspace{0.2cm}},
        attach boxed title to top left={xshift=-.205\linewidth, yshift= -7 mm},
        minipage boxed title=.143\linewidth,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% DEMONSTRATION
    SQ/.style={
        ...
        colbacktitle=white,
        coltitle=viol,
        before={\vspace{0.1cm}}, % space before
        after={\vspace{0.5cm}},  % after the box
        attach boxed title to top left={xshift=-.17\linewidth, yshift= -7 mm}, % xshift, how much you shift title in comparison to the box
        minipage boxed title=.11\linewidth, % this thing is how far the underline for proof is going
        after upper={\hfill$\qed$},
        left skip={.1\linewidth}, % this changes how far you put the box to the right side
        overlay unbroken ={
...
%---------------------------------
% replace section by chapter here if needed.
\newtcolorbox[auto counter, number within=section]{entrainement}[2][]{title={\hypertarget{exer:#2}{Entrainement \thetcbcounter.\hfill\hyperlink{sol:#2}{Solution}}},#1, ST}
% replace section by chapter here if needed.
\newtcolorbox[auto counter, number within=section]{soluENT}[2][]{title={\hypertarget{sol:#2}{Correction \thetcbcounter.\hfill\hyperlink{exer:#2}{Exercise}}},#1, SSE}

%---------------------------------
% replace section by chapter here if needed.
\newtcolorbox[use counter from=entrainement, number within=section]{ajoutationO}[2][]{title={\hypertarget{exer:#2}{Exercice \thetcbcounter.\hfill\hyperlink{sol:#2}{Solution}}},#1, SO}
% replace section by chapter here if needed.
\newtcolorbox[use counter from=soluENT, number within=section]{solu}[2][]{title={\hypertarget{sol:#2}{Solution \thetcbcounter.\hfill\hyperlink{exer:#2}{Exercice}}},#1, SS}


%annonce d'exos
% replace section by chapter here if needed.
\newtcbtheorem[auto counter, number within=section]{ajoutationO*}{Exercices}{SO*}{theo}