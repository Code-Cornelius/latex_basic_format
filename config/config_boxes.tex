...
\tcbset{   
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EXEMPLES
    SV/.style={
        ...
        before={\vspace{0.2cm}}, 
        after={\vspace{0.2cm}},      
        attach boxed title to top left={xshift=-.2\linewidth, yshift= -7 mm},
    ...
    SQ/.style={
        ...
        attach boxed title to top left={xshift=-.2\linewidth, yshift= -7 mm}, % xshift, how much you shift title in comparison to the box
