...
\tcbset{   
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EXEMPLES
    ...
    SQ/.style={
        ...
        after={\vspace{0.8cm}},  % after the box
        attach boxed title to top left={xshift=-.2\linewidth, yshift= -11 mm}, % xshift, how much you shift title in comparison to the box
        minipage boxed title=.13\linewidth, % this thing is how far the underline for proof is going
        after upper={\hfill$\qed$},
        left skip={.14\linewidth}, % this changes how far you put the box to the right side
        overlay unbroken ={
